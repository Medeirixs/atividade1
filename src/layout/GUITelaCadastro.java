...
public class GUITelaCadastro extends javax.swing.JInternalFrame {
    ...
    public void cadastrar() throws SQLException{
        ...
        u.setIdade(String.valueOf(jcbIdade.getSelectedItem()));
        u.setSexo(buttonGroupSexo.getSelection().getActionCommand());
        u.setPeso(Integer.parseInt(jtfPeso.getText()));
        u.setAltura(Double.parseDouble(jtfAltura.getText()));
        u.setEndereco(jtfEndereco.getText());
        u.setCidade(jtfCidade.getText());
        u.setEstado(String.valueOf(jcbEstados.getSelectedItem()));
        u.setEmail(jtfEmail.getText());
        u.setDoencas(textAreaDoenca.getText());
        u.setAlergias(textAreaAlergia.getText());
        u.setTelefone(Integer.parseInt(jtfTelefone.getText()));
        u.setCpf(Integer.parseInt(jtfCpf.getText()));
        ...
        JOptionPane.showMessageDialog(null, "Dados cadastrados: "+u, "Cadastros", JOptionPane.INFORMATION_MESSAGE);
    }catch(Exception e){
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jlIdade, javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addComponent(jlPeso)
                                        .addComponent(jlAltura))
                                    .addGap(24, 24, 24)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jtfPeso, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jcbIdade, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jtfAltura, javax.swing.GroupLayout.PREFERRED_SIZE, 77, javax.swing.GroupLayout.PREFERRED_SIZE)))))
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(8, 8, 8)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jlAltura, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
