...
public class GUIBuscaUsuario extends javax.swing.JInternalFrame {
	...
	new Object[][]{},
	new Object[]{"id", "idade", "nome", "peso", "altura", "endereco", "cidade", "estado", "email", "doencas", "alergias", "telefone", "cpf","sexo"}
    );
...
JOptionPane.showMessageDialog(null, "Erro ao filtrar os dados! "+e.getMessage(),"Erro!", JOptionPane.ERROR_MESSAGE);
    ...
    public void alterarDados(){
        int linha = jTableResultado.getSelectedRow();
        if(linha!= -1){
          jtfIdadeAltera.setText((String)jTableResultado.getValueAt(linha,1)); 
          jtfNomeCompletoAltera.setText((String)jTableResultado.getValueAt(linha,2));
          jtfPesoAltera.setText((String)jTableResultado.getValueAt(linha,3));
          jtfAlturaAltera.setText((String)jTableResultado.getValueAt(linha,4));
          jtfEnderecoAltera.setText((String)jTableResultado.getValueAt(linha,5));
          jtfCidadeAltera.setText((String)jTableResultado.getValueAt(linha, 6));
          jtfEstado.setText((String)jTableResultado.getValueAt(linha,7));
          jtfEmailAltera.setText((String)jTableResultado.getValueAt(linha, 8));
          jtfDoencasAltera.setText((String)jTableResultado.getValueAt(linha, 9)); 
          jtfAlergiasAltera.setText((String)jTableResultado.getValueAt(linha,10));
          jtfTelefoneAltera.setText((String)jTableResultado.getValueAt(linha, 11));
          jtfCpfAltera.setText((String)jTableResultado.getValueAt(linha, 12));
          jtfSexo.setText((String)jTableResultado.getValueAt(linha, 13));
    ...
    public void confirmarAlteracao(){
        try{
            ...
            uVo.setEmail(jtfEstado.getText());
    ...
    private void initComponents() {
        ...
        jtfEstado.setPreferredSize(new java.awt.Dimension(250, 24));
        ...
        jlEstado.setForeground(new java.awt.Color(1, 1, 1));
        jlEstado.setText("Estado:");

        jtfEmailAltera.setPreferredSize(new java.awt.Dimension(250, 24));

        jlSexo.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jlSexo.setForeground(new java.awt.Color(1, 1, 1));
        jlSexo.setText("Sexo:");

        jtfSexo.setPreferredSize(new java.awt.Dimension(80, 24));
        ...
        jPanelPesquisarUsuarioLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelPesquisarUsuarioLayout.createSequentialGroup()
                ...
                .addGap(580, 608, Short.MAX_VALUE))
            .addGroup(jPanelPesquisarUsuarioLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanelPesquisarUsuarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelPesquisarUsuarioLayout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanelPesquisarUsuarioLayout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanelPesquisarUsuarioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanelPesquisarUsuarioLayout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(jtfEnderecoAltera, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                            .addGroup(jPanelPesquisarUsuarioLayout.createSequentialGroup()
